...
class MLPMaskDecoder(BaseDecodeHead):
    def __init__(self, in_features, hidden_features, out_features, num_classes=1, mlp_num_layers=3, 
                 loss_cls=dict(
    ...
    def forward_train(self, x,
        ...
        return self.loss(cls_scores, mask_preds, gt_labels, gt_masks, img_metas)
